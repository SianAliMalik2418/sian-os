...
import { CalendarRange, CheckCircle2, Droplets, Moon, Pencil, Scale, Trash2, Utensils } from 'lucide-react'
...
type MetricKey = 'weight_kg' | 'sleep_hours' | 'water_liters' | 'protein_grams'
